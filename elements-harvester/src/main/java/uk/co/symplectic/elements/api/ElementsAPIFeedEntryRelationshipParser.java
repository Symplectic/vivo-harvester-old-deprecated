...
class ElementsAPIFeedEntryRelationshipParser implements ElementsFeedEntryParser {
    private ElementsAPIFeedRelationshipStreamHandler streamHandler;

    private String encoding = null;
    private String version = null;

    ElementsAPIFeedEntryRelationshipParser(ElementsAPIFeedRelationshipHandler handler) {
        if (handler instanceof ElementsAPIFeedRelationshipStreamHandler) {
            this.streamHandler = (ElementsAPIFeedRelationshipStreamHandler)handler;
        }
    }
        ...
        while (entryReader.hasNext()) {
            ...
            switch (entryReader.getEventType()) {
                case XMLStreamConstants.START_ELEMENT:
                    ...
                    if ("api".equals(prefix) && "relationship".equals(name)) {
